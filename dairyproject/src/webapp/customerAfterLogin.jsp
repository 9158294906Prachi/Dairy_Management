...
.banner {
	background-image:url('https://png.pngtree.com/thumb_back/fh260/background/20230610/pngtree-dairy-products-in-bottles-and-bowls-image_2950735.jpg');
	padding: 250px 0;
	text-align: center;
			...
			<div class="container">
				...
				<nav>
					<ul class="list">
						...
						<li class="list1"><a href="customerAfterLogin.jsp">Products</a></li>
					...
					<div class="icons">
						<a href=""> <i class="fa-solid fa-heart"></i></a> <a
							href="mycart"><i class="fa-solid fa-cart-shopping"></i></a> <a
